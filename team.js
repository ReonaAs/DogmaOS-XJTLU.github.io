...
const MEMBERS_DATA = [
    ...
    // 导师(PIs) - 完全按照文档顺序
    { id: '21', name: 'Yongtao Zhu', role: 'Principal Investigator', group: 'PI', quote: 'Mentoring the next generation.', emoji: '👨‍🎓' },
    { id: '22', name: 'Kevin C. Chan', role: 'Secondary Principal Investigator', group: 'PI', quote: 'Guiding discovery.', emoji: '👨‍🎓' },
    { id: '23', name: 'Ziwen Xie', role: 'Instructor', group: 'PI', quote: 'Supporting innovation.', emoji: '👨‍🎓' },
];
